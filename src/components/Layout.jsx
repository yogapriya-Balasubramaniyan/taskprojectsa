...
const Layout = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row bg-slate-50">
      ...
      {/* Mobile Top Navbar */}
      <header className="flex h-16 items-center justify-between border-b border-slate-205 bg-white px-4 md:hidden shrink-0">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-600 text-white font-bold text-base">
            T
          </div>
      ...
      <aside className="hidden w-64 flex-col border-r border-slate-200 bg-white p-5 md:flex shrink-0">
        ...
        <div className="border-t border-slate-100 pt-4 mt-auto">
          <div className="mb-4 px-3">
            ...
            <span className="block truncate text-sm font-medium text-slate-700" title={userEmail}>
              {userEmail}
            </span>
          </div>
          <button
            onClick={handleLogout}
            className="flex w-full items-center space-x-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-600 hover:bg-red-50 hover:text-red-650 transition-colors cursor-pointer"
          >
